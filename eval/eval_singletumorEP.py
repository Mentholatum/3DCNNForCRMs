...
from lib.dataloader.singletumor_EP import SingleTumorEP
...
def get_arguments():
    parser = argparse.ArgumentParser(description='Single Tumor EP Segmentation')
    parser.add_argument('--batchSz', type=int, default=1)
    parser.add_argument('--dataset_name', type=str, default="singletumorEP")
    ...
    parser.add_argument('--resume',
                        # default="/media/data1/jiachuang/projects/kidney/train/saved_models/VNET_checkpoints/VNET_singletumorEP_08_22_06_36/VNET_singletumorEP_08_22_06_36_BEST.pth",
                        default="/media/data1/jiachuang/projects/kidney/train/saved_models/UNET3D_checkpoints/UNET3D_singletumorEP_08_22_10_27/UNET3D_singletumorEP_08_22_10_27_BEST.pth",
