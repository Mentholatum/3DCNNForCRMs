...
sys.path.append('/media/data1/jiachuang/projects/kidney')
...
from lib.dataloader.singletumor_T1WI import SingleTumorT1WI
...
def get_arguments():
    parser = argparse.ArgumentParser(description='Single Tumor T1WI Segmentation')
    parser.add_argument('--batchSz', type=int, default=1)
    parser.add_argument('--dataset_name', type=str, default="singletumorT1WI")
    parser.add_argument('--classes', type=int, default=2)
    parser.add_argument('--inChannels', type=int, default=1)
    parser.add_argument('--inModalities', type=int, default=1)
    parser.add_argument('--dropout_rate', default=0.6, type=float, help='dropout rate')
    parser.add_argument('--lr', default=1e-4, type=float,
                        help='learning rate (default: 1e-2)')
    parser.add_argument('--cuda', action='store_true', default=True)
    parser.add_argument('--resume',
                        default="/media/data1/jiachuang/projects/kidney/train/saved_models/VNET_checkpoints/VNET_singletumorT1WI_08_25_01_00/VNET_singletumorT1WI_08_25_01_00_BEST.pth",
                        # default="/media/data1/jiachuang/projects/kidney/train/saved_models/UNET3D_checkpoints/UNET3D_singletumorT1WI/UNET3D_singletumorT1WI_BEST.pth",
...
def main():
    ...
    # Custom data loaders
    test_loader = SingleTumorT1WI('test')
    test_generator = DataLoader(test_loader, batch_size=1, shuffle=False, num_workers=2)
    train_loader = SingleTumorT1WI('train')
    ...
    with torch.no_grad():
        for idx, input_tuple in enumerate(test_generator):
        ...
        avg_acc1 = dice / len(test_generator)
        avg_acc5 = pre / len(test_generator)
        avg_acc6 = hausd / len(test_generator)
