...
from lib.dataloader.singletumor_CP import SingleTumorCP
...
def get_arguments():
    parser = argparse.ArgumentParser(description='Single Tumor CP Segmentation')
    parser.add_argument('--batchSz', type=int, default=1)
    parser.add_argument('--dataset_name', type=str, default="singletumorCP")
    ...
    parser.add_argument('--resume',
                        # default="../train/saved_models/VNET_checkpoints/VNET_singletumorCP/VNET_singletumorCP_BEST.pth",
                        # default='../train/saved_models/VNET_checkpoints/VNET_singletumorCP_08_25_07_25/VNET_singletumorCP_08_25_07_25_BEST.pth',
                        default='../train/saved_models/BEST/VNET_singletumorCP_10_09_02_42_BEST.pth',

                        # default='../train/saved_models/UNET3D_checkpoints/UNET3D_singletumorCP_08_26_00_31/UNET3D_singletumorCP_08_26_00_31_BEST.pth',
                        # default="../train/saved_models/UNET3D_checkpoints/UNET3D_singletumorCP/UNET3D_singletumorCP_BEST.pth",
...
def main():
    ...
    with torch.no_grad():
        ...
        for idx, input_tuple in enumerate(training_generator):
            if idx == int(len(training_generator) / 2):
                break
