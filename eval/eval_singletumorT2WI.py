...
from lib.dataloader.singletumor_T2WI import SingleTumorT2WI
...
def get_arguments():
    parser = argparse.ArgumentParser(description='Single Tumor T2WI Segmentation')
    parser.add_argument('--batchSz', type=int, default=1)
    parser.add_argument('--dataset_name', type=str, default="singletumorT2WI")
...
def main():
    ...
    # Custom data loaders
    train_loader = SingleTumorT2WI('train')
    val_loader = SingleTumorT2WI('test')
    val_generator = DataLoader(val_loader, batch_size=1, shuffle=False, num_workers=4)
    training_generator = DataLoader(train_loader, batch_size=1, shuffle=False, num_workers=4)
