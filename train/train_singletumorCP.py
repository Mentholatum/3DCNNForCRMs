...
def main():
    ...
    val_loader = SingleTumorCP('val')
    training_generator = DataLoader(train_loader, batch_size=args.batchSz, shuffle=True, num_workers=8)
    val_generator = DataLoader(val_loader, batch_size=1, shuffle=True, num_workers=8)
