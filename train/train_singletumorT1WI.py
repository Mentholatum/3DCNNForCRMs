...
def main():
    ...
    val_loader = SingleTumorT1WI('val')
    training_generator = DataLoader(train_loader, batch_size=args.batchSz, shuffle=True, num_workers=4)
    val_generator = DataLoader(val_loader, batch_size=args.batchSz, shuffle=True, num_workers=4)
