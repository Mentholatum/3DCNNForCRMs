...
train_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_t/train/excretory phase"
train_label_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_t/label/excretory phase"
val_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_v/train/excretory phase"
val_label_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_v/label/excretory phase"
...
if __name__ == '__main__':
    ...
    #     nib.save(new_img,
    #              '/media/data1/jiachuang/projects/kidney/data/single/excretory phase/train/img/aug_{}.nii.gz'.format(i))
    #     nib.save(new_lab,
    #              '/media/data1/jiachuang/projects/kidney/data/single/excretory phase/train/label/aug_{}.nii.gz'.format(
    #                  i))
    ...
    #     new_img = nib.Nifti1Image(img_save, np.eye(4))
    #     new_lab = nib.Nifti1Image(lab_save, np.eye(4))
    #     nib.save(new_img, '/media/data1/jiachuang/projects/kidney/data/single/excretory phase/train/img/ori_{}.nii.gz'.format(i))
    #     nib.save(new_lab, '/media/data1/jiachuang/projects/kidney/data/single/excretory phase/train/label/ori_{}.nii.gz'.format(i))
    # print("Training dataset original cropped FINISH.")

    # validating dataset augmentation Single tumor ep
    for i in range(len(list_val)):
        ...
        new_lab = nib.Nifti1Image(lab_save, np.eye(4))
        nib.save(new_img,
                 '/media/data1/jiachuang/projects/kidney/data/single/excretory phase/val/img/{}_{}.nii.gz'.format(str(i).zfill(2),
                                                                                                                  list_val[i].split("/")[-1].split(".")[0]))
        nib.save(new_lab,
                 '/media/data1/jiachuang/projects/kidney/data/single/excretory phase/val/label/{}_{}.nii.gz'.format(str(i).zfill(2),
                                                                                                                    list_val[i].split("/")[-1].split(".")[0]))
