...
train_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_t/train/DWI"
train_label_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_t/label/DWI"
val_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_v/train/DWI"
val_label_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_v/label/DWI"
...
if __name__ == '__main__':
    ...
    #     nib.save(new_img, '/media/data1/jiachuang/projects/kidney/data/single/DWI/train/img/aug_{}_{}.nii.gz'.format(
    #                  str(i).zfill(2), list_train[i].split("/")[-1].split(".")[0]))
    #     nib.save(new_lab, '/media/data1/jiachuang/projects/kidney/data/single/DWI/train/label/aug_{}_{}.nii.gz'.format(
    #                  str(i).zfill(2), list_train[i].split("/")[-1].split(".")[0]))
    ...
    for i in range(len(list_train)):
        ...
        new_img = nib.Nifti1Image(img_save, np.eye(4))
        new_lab = nib.Nifti1Image(lab_save, np.eye(4))
        nib.save(new_img, '/media/data1/jiachuang/projects/kidney/data/single/DWI/train/img/ori_{}_{}.nii.gz'.format(
                     str(i).zfill(3), list_train[i].split("/")[-1].split(".")[0]))
        nib.save(new_lab, '/media/data1/jiachuang/projects/kidney/data/single/DWI/train/label/ori_{}_{}.nii.gz'.format(
                     str(i).zfill(3), list_train[i].split("/")[-1].split(".")[0]))
    print("Training dataset original cropped FINISH.")

    # validating dataset augmentation Single tumor DWI
    ...
    #     new_img = nib.Nifti1Image(img_save, np.eye(4))
    #     new_lab = nib.Nifti1Image(lab_save, np.eye(4))
    #     nib.save(new_img, '/media/data1/jiachuang/projects/kidney/data/single/DWI/val/img/{}_{}.nii.gz'.format(str(i).zfill(2), list_val[i].split("/")[-1].split(".")[0]))
    #     nib.save(new_lab, '/media/data1/jiachuang/projects/kidney/data/single/DWI/val/label/{}_{}.nii.gz'.format(str(i).zfill(2),list_val[i].split("/")[-1].split(".")[0]))
