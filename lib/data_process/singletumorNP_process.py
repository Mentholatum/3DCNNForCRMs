...
train_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_t/train/nephrographic phase"
train_label_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_t/label/nephrographic phase"
val_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_v/train/nephrographic phase"
val_label_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_v/label/nephrographic phase"
...
if __name__ == '__main__':
    ...
    #     img_save = aug_train[i]['image'].squeeze(0)
    #     lab_save = aug_train[i]['label'].squeeze(0)
    ...
    #     nib.save(new_img,
    #              '/media/data1/jiachuang/projects/kidney/data/single/nephrographic phase/train/img/aug_{}.nii.gz'.format(
    #                  i))
    #     nib.save(new_lab,
    #              '/media/data1/jiachuang/projects/kidney/data/single/nephrographic phase/train/label/aug_{}.nii.gz'.format(
    #                  i))
    # print("Training dataset augmentation transformed FINISH.")

    # training dataset original crop Single tumor np
    # for i in range(len(list_train)):
    #     img_save = ori_train[i]['image'].squeeze(0)
    #     lab_save = ori_train[i]['label'].squeeze(0)
    ...
    #     new_img = nib.Nifti1Image(img_save, np.eye(4))
    #     new_lab = nib.Nifti1Image(lab_save, np.eye(4))
    #     nib.save(new_img, '/media/data1/jiachuang/projects/kidney/data/single/nephrographic phase/train/img/ori_{}.nii.gz'.format(i))
    #     nib.save(new_lab, '/media/data1/jiachuang/projects/kidney/data/single/nephrographic phase/train/label/ori_{}.nii.gz'.format(i))
    # print("Training dataset original cropped FINISH.")

    # validating dataset augmentation Single tumor np
    for i in range(len(list_val)):
        ...
        new_img = nib.Nifti1Image(img_save, np.eye(4))
        new_lab = nib.Nifti1Image(lab_save, np.eye(4))
        nib.save(new_img, '/media/data1/jiachuang/projects/kidney/data/single/nephrographic phase/val/img/{}_{}.nii.gz'.format(str(i).zfill(2),list_val[i].split("/")[-1].split(".")[0]))
        nib.save(new_lab, '/media/data1/jiachuang/projects/kidney/data/single/nephrographic phase/val/label/{}_{}.nii.gz'.format(str(i).zfill(2),list_val[i].split("/")[-1].split(".")[0]))
