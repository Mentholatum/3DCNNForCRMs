...
train_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_t/train/corticomedullary phase"
train_label_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_t/label/corticomedullary phase"
val_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_v/train/corticomedullary phase"
val_label_path = "/media/data1/jiachuang/data/medical/301segmentation_singletumor_v/label/corticomedullary phase"
...
if __name__ == '__main__':
    ...
    for i in range(len(list_train)):
        ...
        nib.save(new_img,
                 '/media/data1/jiachuang/projects/kidney/data/single/corticomedullary phase/train/img/aug_{}_{}.nii.gz'.format(
                     str(i).zfill(2), list_train[i].split("/")[-1].split(".")[0]))
        new_lab = nib.Nifti1Image(lab_save, np.eye(4))
        nib.save(new_lab,
                 '/media/data1/jiachuang/projects/kidney/data/single/corticomedullary phase/train/label/aug_{}_{}.nii.gz'.format(
                     str(i).zfill(2), list_train[i].split("/")[-1].split(".")[0]))
    ...
    for i in range(len(list_train)):
        ...
        new_img = nib.Nifti1Image(img_save, np.eye(4))
        nib.save(new_img,
                 '/media/data1/jiachuang/projects/kidney/data/single/corticomedullary phase/train/img/ori_{}_{}.nii.gz'.format(
                     str(i).zfill(2), list_train[i].split("/")[-1].split(".")[0]))
        new_lab = nib.Nifti1Image(lab_save, np.eye(4))
        nib.save(new_lab,
                 '/media/data1/jiachuang/projects/kidney/data/single/corticomedullary phase/train/label/ori_{}_{}.nii.gz'.format(
                     str(i).zfill(2), list_train[i].split("/")[-1].split(".")[0]))
    print("Training dataset original cropped FINISH.")

    # validating dataset augmentation Single tumor CP
    ...
    #           aug_val[i]['label'].min())
    #     new_img = nib.Nifti1Image(img_save, np.eye(4))
    #     nib.save(new_img, '/media/data1/jiachuang/projects/kidney/data/single/corticomedullary phase/val/img/{}_{}.nii.gz'.format(
    #         str(i).zfill(2),list_val[i].split("/")[-1].split(".")[0]))
    #     new_lab = nib.Nifti1Image(lab_save, np.eye(4))
    #     nib.save(new_lab, '/media/data1/jiachuang/projects/kidney/data/single/corticomedullary phase/val/label/{}_{}.nii.gz'.format(
    #         str(i).zfill(2),list_val[i].split("/")[-1].split(".")[0]))
