...
class DownTransition(nn.Module):
    def __init__(self, inChans, nConvs, elu, dropout=False, dropout_rate=0.5):
...
class UpTransition(nn.Module):
    def __init__(self, inChans, outChans, nConvs, elu, dropout=False, dropout_rate=0.5):
...
class VNet(nn.Module):
    ...
    def __init__(self, elu=True, in_channels=1, classes=4, dropout_rate=0.5):
        ...
        self.down_tr128 = DownTransition(64, 3, elu, dropout=True, dropout_rate=dropout_rate)
        self.down_tr256 = DownTransition(128, 2, elu, dropout=True, dropout_rate=dropout_rate)
        self.up_tr256 = UpTransition(256, 256, 2, elu, dropout=True, dropout_rate=dropout_rate)
        self.up_tr128 = UpTransition(256, 128, 2, elu, dropout=True, dropout_rate=dropout_rate)
